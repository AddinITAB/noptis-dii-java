...
public class SchemaResourceResolver implements LSResourceResolver {
    ...
    SchemaResourceResolver(String schemaList) throws IOException {
    ...
    private LSInput createInput(final String systemId, final String baseUri) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        return new LSInput() {
